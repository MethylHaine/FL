...
public class ChercherDicho3Test {
	...
	@Test
	public void chercherDicho3ElementInTableTest() {
		Article articleToFind = new Article("Article3", 52, 3);
		assertTrue(magasin.chercherDicho3(articleToFind));
		assertTrue(articleValid3.isEqual(articleToFind));
	}
	
	@Test
	public void chercherDicho3ElementNotInTableTest() {
		Article articleToFindFalse = new Article("ToFindFalse", 51.5, 5);
		assertFalse(magasin.chercherDicho3(articleToFindFalse));
		assertFalse(articleValid3.isEqual(articleToFindFalse));
	}

	@Test
	public void chercherDicho3ElementWrongName() {
		Article articleToFindWrongName = new Article("WrongName", 52, 3);
		assertFalse(magasin.chercherDicho3(articleToFindWrongName));
		assertFalse(articleValid3.isEqual(articleToFindWrongName));	
	}
	
	@Test
	public void chercherDicho3ElementWrongNumber() {
		Article articleToFindWrongNumber = new Article("Article3", 52, 5);
		assertFalse(magasin.chercherDicho3(articleToFindWrongNumber));
		assertFalse(articleValid3.isEqual(articleToFindWrongNumber));
	}
	
	@Test
	public void chercherDicho3ElementWrongPrice() {
		Article articleToFindWrongPrice = new Article("Article3", 52.01, 3);
		assertFalse(magasin.chercherDicho3(articleToFindWrongPrice));
	...
	public void chercherDichoElementMini() {
		...
		assertFalse(magasin.chercherDicho3(articleFree)) ;
		magasin.insererArticle(articleFree);
		assertTrue(magasin.chercherDicho3(articleFree)) ;
	}
	
	@Test
	public void chercherDichoElementMax() {
		Article articleExpensive = new Article("Article3", 10000.01, 3);
		assertFalse(magasin.chercherDicho3(articleExpensive)) ;
		magasin.insererArticle(articleExpensive);
		assertTrue(magasin.chercherDicho3(articleExpensive)) ;
	}
}
