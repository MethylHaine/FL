...
public class ChercherDicho5Test {
	...
	@Test
	public void chercherDicho5ElementInTableTest() {
		Article articleToFind = new Article("Article3", 52, 3);
		assertTrue(magasin.chercherDicho5(articleToFind));
		assertTrue(articleValid3.isEqual(articleToFind));
	}
	
	@Test
	public void chercherDicho5ElementNotInTableTest() {
		Article articleToFindFalse = new Article("ToFindFalse", 51.5, 5);
		assertFalse(magasin.chercherDicho5(articleToFindFalse));
		assertFalse(articleValid3.isEqual(articleToFindFalse));
	}

	@Test
	public void chercherDicho5ElementWrongName() {
		Article articleToFindWrongName = new Article("WrongName", 52, 3);
		assertFalse(magasin.chercherDicho5(articleToFindWrongName));
		assertFalse(articleValid3.isEqual(articleToFindWrongName));	
	}
	
	@Test
	public void chercherDicho5ElementWrongNumber() {
		Article articleToFindWrongNumber = new Article("Article3", 52, 5);
		assertFalse(magasin.chercherDicho5(articleToFindWrongNumber));
		assertFalse(articleValid3.isEqual(articleToFindWrongNumber));
	}
	
	@Test
	public void chercherDicho5ElementWrongPrice() {
		Article articleToFindWrongPrice = new Article("Article3", 52.01, 3);
		assertFalse(magasin.chercherDicho5(articleToFindWrongPrice));
	...
	public void chercherDichoElementMini() {
		...
		assertFalse(magasin.chercherDicho5(articleFree)) ;
		magasin.insererArticle(articleFree);
		assertTrue(magasin.chercherDicho5(articleFree)) ;
	}
	
	@Test
	public void chercherDichoElementMax() {
		Article articleExpensive = new Article("Article3", 10000.01, 3);
		assertFalse(magasin.chercherDicho5(articleExpensive)) ;
		magasin.insererArticle(articleExpensive);
		assertTrue(magasin.chercherDicho5(articleExpensive)) ;
	}
}
